...
export function SearchComponent() {
    ...
    return (
        <div className="center">
            <form className="form-input" role="search" onSubmit={searchHandle}>
            <ButtonGroup >
                <input id='inputBox' placeholder="search by category..." type='text' onChange={(e)=>setKey(e.target.value)} />
